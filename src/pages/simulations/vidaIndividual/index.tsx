    ...
    <>
      ...
      <div className="flex items-center justify-between w-full">
        <div className="flex flex-col lg:flex-row items-start lg:items-center rounded bg-white shadow md:w-full ">
          ...
          <div className="dark:border-gray-700  border-t lg:border-t-0 lg:border-r lg:border-l lg:rounded-r dark:bg-gray-700 bg-gray-100 md:w-100 bg-none">      <PriceSimulator /></div>
