            ...
            <div className="w-full relative lg:w-1/2 xl:mt-10 mb-10 2xl:pr-24 2xl:pl-0 xl:pl-12 pl-0 ">
              ...
              <div className="w-full flex flex-col items-start  xl:justify-start  relative z-20 xl:px-0 px-4 xl:py-0 py-4">
                <div className="w-full 2xl:pl-48 xl:pt-1">
                  <h1 className="text-5xl md:text-2xl lg:text-4xl font-bold tracking-wider text-gray-800">
                  ...
                  <div className="w-full md:w-10/12 mt-3">
                    ...
                    <div className="mt-4 md:mt-8">
                      ...
                      <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">
                        +xx xxx xxxxxxxxxx(Telefone)
                      </h2>
                      <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">
                      +xx xxx xxxxxxxxxx (WhatsApp)
                      </h2>
                    </div>
                    <div className="mt-4 md:mt-8">
                      <h2 className="text-sm md:text-base text-blue-700 font-semibold">
            ...
            <div className="w-full lg:w-1/2   xl:pt-10 lg:pl-24">
              <div className="flex flex-col items-start xl:justify-start 2xl:justify-end xl:px-0 px-4">
                ...
                <div className="w-full 2xl:w-8/12 mt-3">
                  ...
                  <div className="mt-4 md:mt-8">
                    <p className="text-gray-800 text-base font-medium">Nome</p>
                    <input
                  ...
                  <div className="mt-4 md:mt-8">
                    ...
                    <input
                      className="mt-3 text-base border-2 w-11/12 lg:w-full xl:w-10/12 hover:border-blue-600 focus:border-blue-600 focus:outline-none border-black py-5 pl-4 text-gray-800"
                      type="email"
                      placeholder="contato@agenciaparanhos.com.br"
                    />
                  </div>
                  <div className="mt-4 md:mt-8">
                    <p className="text-gray-800 text-base font-medium">
