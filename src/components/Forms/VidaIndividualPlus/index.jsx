  ...
  return (
    ...
    >
      <div className="flex md:flex-row flex-col items-center py-8 px-4">
        ...
        {/* EXPEDIÇÃO */}
        <div className="flex flex-col md:mr-16 md:py-0 py-4  md:py-0 py-4">
          <label
            htmlFor="gender"
            className="text-gray-800 dark:text-gray-100 text-sm font-bold leading-tight tracking-normal mb-2"
          >
        ...
        {/* fumante */}
        <div className="flex flex-col md:py-0 py-4  md:py-0 py-4">
          <label
            htmlFor="email3"
            className="text-gray-800 dark:text-gray-100 text-sm font-bold leading-tight tracking-normal mb-2"
          >
...
export default FormVidaIndividualPlus;
