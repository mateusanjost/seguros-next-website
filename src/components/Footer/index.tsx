    ...
    <div className="pt-12">
      <footer id="footer" className="relative z-50 dark:bg-gray-900 pt-24">
        ...
        <div className="py-16 flex flex-col justify-center items-center">
          <Link href="https://agenciaparanhos.com.br/">
            <a>
              <img className="h-10 w-100 sm:h-15" src="https://agenciaparanhos.com.br/images/5471fcb2b4e27a0959ecd72ff15446a3.png" alt="paranhos"></img>
                 </a>
          </Link>
        
        
          <p className="mt-6 text-xs lg:text-sm leading-none text-gray-900 dark:text-gray-50">
            2021 Paranhos - Mar del Plata. All Rights Reserved.
          </p>
        </div>
      </footer>
    </div>
